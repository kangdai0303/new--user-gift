...
class NewUserGiftPage {
    ...
    handleDownloadApp() {
        ...
        if (/iPad|iPhone|iPod/.test(userAgent) && !window.MSStream) {
            // iOS设备 - 提供多个备选链接
            downloadUrls = [
                'https://apps.apple.com/cn/app/id6702016387', // 简化链接
                'https://apps.apple.com/cn/app/%E9%AB%98%E9%80%94%E5%8C%BB%E8%80%83/id6702016387', // 原始链接
                'itms-apps://itunes.apple.com/cn/app/id6702016387', // iOS专用协议
                'https://yikao.gaotuyk.com/#/pages/recruit/notice_detail?id=489&share=app&share=h5&invitationCode=p_1101AVShmN&invitationCode=p_0918PNnatY' // 备选下载页
            ];
        } else if (/android/i.test(userAgent)) {
            // Android设备 - 提供多个备选链接
            downloadUrls = [
                'https://yikao.gaotuyk.com/#/pages/recruit/notice_detail?id=489&share=app&share=h5&invitationCode=p_1101AVShmN&invitationCode=p_0918PNnatY', // 主链接
                'https://yikao.gaotuyk.com/#/pages/recruit/notice_detail?id=489&share=app', // 简化链接
                'https://yikao.gaotuyk.com/' // 备选主页
            ];
        } else {
            // 其他设备 - 通用下载页面
            downloadUrls = [
                'https://yikao.gaotuyk.com/#/pages/recruit/notice_detail?id=489&share=app&share=h5&invitationCode=p_1101AVShmN&invitationCode=p_0918PNnatY',
                'https://yikao.gaotuyk.com/'
            ];
        }
        
        // 尝试多个链接下载
        this.tryMultipleDownloadLinks(downloadUrls);
